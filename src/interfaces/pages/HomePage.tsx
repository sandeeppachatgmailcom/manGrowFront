    ...
    return (
        <div className="md:flex w-full ">
            ...
            <div className={`block xl:w-4/6 h-full w-full overflow-scroll   ${darkTheme.theme} ${divlign} `}>
                ...
                <div className=" flex h-20 justify-end  p-2 rounded-md ">
                    <button onClick={()=>{setMenu(0)}} className=" h-[50px] font-semibold shadow-md  rounded-md border  w-32 bg-blue-700 bg-opacity-15 m-2">PENDINGS </button>
                    <button onClick={()=>{setMenu(1)}} className=" h-[50px] font-semibold shadow-md  rounded-md border  w-32 bg-blue-700 bg-opacity-15 m-2 ">HISTORY </button>
                </div>
