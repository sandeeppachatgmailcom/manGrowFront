        ...
        return (
                <div>
                        {formData?.type == 'taskCreation' ?
                                ...
                                <div className={`${formData && formData?.ScheduledTaskID ? 'bg-blue-600 bg-opacity-10' : ''} overflow-hidden w-full  h-[${height}] border border-opacity-25    hover:shadow-sm hover:shadow-gray-500 border-gray-300 focus:bg-opacity-55 focus:bg-gray-600  rounded-xl `} >

                                        <div className="justify-start  bg-opacity-5">
                                                <ToastContainer />
                                                <div className="xl:flex  xl:justify-between justify-between  border-b w-full  border-b-gray-300">
                                                        ...
                                                        <div className="md:w-3/6 p-3 flex justify-end ">
